...
export function Logo({ className }: { className?: string }) {
  return (
    <span className={cn('inline-flex items-center gap-2 sm:gap-2.5', className)}>
      <svg viewBox="4 1 24 28" aria-hidden="true" className="h-7 w-auto shrink-0 sm:h-8">
      ...
      <span className="font-display text-lg tracking-[0.06em] whitespace-nowrap text-bone sm:text-xl">
        {BRAND_NAME}
      </span>
    </span>
  );
